    ...
    interactive(interactive_cmd, "",
                function (I) {
                    if (color_theme_toggle[name]) {
                        global_color_theme_unregister(styles);
                    } else {
                        global_color_theme_register(styles);
                    }
                });
    define_key(default_global_keymap, key, interactive_cmd);
}

function global_color_theme_register(styles) {
                        for(x in styles) {
...
function global_color_theme_unregister(styles) {
                        for(x in styles) {
...
global_color_theme(
    ...
    [make_css_data_uri(
        ...
        'background: #120F14 !important;'+
         ...
         // 'font-family: Ubuntu Mono !important; '+
         // 'font-family: Ubuntu !important; '+
         // 'font-family: RictyDiminished !important; '+
         // 'font-weight: lighter !important; '+
         // 'font-size: 10pt !important; '+
         'font-size: 10pt !important; '+
         '-moz-border-bottom-colors: #505050 #505050 !important; '+
         ...
         // 'p { line-height: 1.5em !important;}',
         'code, pre, code *, pre * { color: #f6f3e8 !important; background-color: #353535 !important; }',
         ':link, :link * { color: #505f89 !important}',
         ':visited, :visited * {  color: #8083be !important}',
